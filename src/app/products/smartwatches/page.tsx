...
const brandOrder = ["Samsung", "Google", "Garmin", "Suunto", "Fossil", "Huawei", "Withings", "Amazfit"];

const grouped = watches.reduce<Record<string, typeof products>>((acc, p) => {
        ...
        <div className="mx-auto max-w-[1440px] px-5 sm:px-6 lg:px-12">
          ...
          <ScrollReveal delay={0.2}>
            <p className="text-sm sm:text-base text-white/30 max-w-lg">
              From rugged outdoor watches to everyday essentials — find your perfect fit.
            </p>
          </ScrollReveal>
        </div>
      </div>
